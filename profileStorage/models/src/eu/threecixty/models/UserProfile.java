...
public interface UserProfile extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.eu.3cixty.org/profile#hasTrayItem
     */
     
    /**
     * Gets all property values for the hasTrayItem property.<p>
     * 
     * @returns a collection of values for the hasTrayItem property.
     */
    Collection<? extends Tray> getHasTrayItem();

    /**
     * Checks if the class has a hasTrayItem property value.<p>
     * 
     * @return true if there is a hasTrayItem property value.
     */
    boolean hasHasTrayItem();

    /**
     * Adds a hasTrayItem property value.<p>
     * 
     * @param newHasTrayItem the hasTrayItem property value to be added
     */
    void addHasTrayItem(Tray newHasTrayItem);

    /**
     * Removes a hasTrayItem property value.<p>
     * 
     * @param oldHasTrayItem the hasTrayItem property value to be removed.
     */
    void removeHasTrayItem(Tray oldHasTrayItem);
