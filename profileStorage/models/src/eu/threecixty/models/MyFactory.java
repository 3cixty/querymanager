...
public class MyFactory implements CodeGenerationFactory {
    ...
    {
        javaMapping.add("http://www.eu.3cixty.org/profile#Tray", Tray.class, DefaultTray.class);
    }

    /**
     * Creates an instance of type Tray.  Modifies the underlying ontology.
     */
    public Tray createTray(String name) {
		return delegate.createWrappedIndividual(name, Vocabulary.CLASS_TRAY, DefaultTray.class);
    }

    /**
     * Gets an instance of type Tray with the given name.  Does not modify the underlying ontology.
     * @param name the name of the OWL named individual to be retrieved.
     */
    public Tray getTray(String name) {
		return delegate.getWrappedIndividual(name, Vocabulary.CLASS_TRAY, DefaultTray.class);
    }

    /**
     * Gets all instances of Tray from the ontology.
     */
    public Collection<? extends Tray> getAllTrayInstances() {
		return delegate.getWrappedIndividuals(Vocabulary.CLASS_TRAY, DefaultTray.class);
    }
