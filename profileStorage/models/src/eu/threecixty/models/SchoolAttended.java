 ...
 * Source Class: SchoolAttended <br>
 * @version generated on Thu Jun 05 16:06:07 CEST 2014 by ragarwal
 */

public interface SchoolAttended extends EventDetails {
    ...
    /* ***************************************************
     * Property http://www.eu.3cixty.org/profile#hasSchool
     */
     
    /**
     * Gets all property values for the hasSchool property.<p>
     * 
     * @returns a collection of values for the hasSchool property.
     */
    Collection<? extends School> getHasSchool();

    /**
     * Checks if the class has a hasSchool property value.<p>
     * 
     * @return true if there is a hasSchool property value.
     */
    boolean hasHasSchool();

    /**
     * Adds a hasSchool property value.<p>
     * 
     * @param newHasSchool the hasSchool property value to be added
     */
    void addHasSchool(School newHasSchool);

    /**
     * Removes a hasSchool property value.<p>
     * 
     * @param oldHasSchool the hasSchool property value to be removed.
     */
    void removeHasSchool(School oldHasSchool);
